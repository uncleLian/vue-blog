<template>
    <div id="exportSelected">
        ...
        <el-table ref="selectedTable" :data="json" v-loading.body="loading" element-loading-text="拼命加载中..." style="width: 100%" border fit :header-cell-style="{'text-align': 'center'}" @selection-change="handleSelectionChange">
